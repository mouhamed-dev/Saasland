...
const FaqSection = () => {
  return (
    <div className="bg-[#020617]" id='faq'>
      <div className="section-container">
        ...
        <div className="max-w-3xl mx-auto bg-[#020617]/90 rounded-xl p-6 md:p-8 border border-gray-800 card-shadow">
          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, index) => (
              <AccordionItem key={index} value={`item-${index}`} className="border-b border-gray-800 last:border-0">
                <AccordionTrigger className="text-left text-white hover:text-emerald-600 py-4">
                  {faq.question}
                </AccordionTrigger>
