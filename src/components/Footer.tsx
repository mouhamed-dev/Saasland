...
const Footer = () => {
  ...
  const oups = (e: React.MouseEvent<HTMLAnchorElement, MouseEvent>) => {
    e.preventDefault();
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              Transformez votre entreprise avec notre solution SaaS de pointe
              conçue pour les entreprises modernes.
            </p>
